...
2. Sustituir `np.interp` por una interpolación consciente del polo (p. ej.
   interpolar `cot δ_p(k)` o `1/A_p`, que son suaves a través de la resonancia)
   — así el hueco de malla dejaría de importar.
